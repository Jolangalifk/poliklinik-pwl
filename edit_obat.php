...
<body>
	...
	<div class="kotak_login" style="width: 600px; position: absolute; left: 35%; top: 130px; margin: 0; margin-top: 0;">
		<p class="tulisan_login" style="margin-bottom: 25px; font-size: 22px;">Update Obat</p>
		...
		<form action="update_obat.php" method="post">
			...
			?>
				...
				<label>ID Obat</label>
				<input type="text" class="form_login" value="<?php echo $data['id_obat'] ?>" disabled>

				<label>Nama Obat</label>
				<input type="text" name="nama_obat" class="form_login" value="<?php echo $data['nama_obat'] ?>" required>

				<label>Stok Obat</label>
				<input type="text" name="stok_obat" class="form_login" value="<?php echo $data['stok_obat'] ?>" required>

				<label>Satuan Obat</label>
				<input type="text" name="satuan_obat" class="form_login" value="<?php echo $data['satuan_obat'] ?>" required>

				<label>Harga Obat</label>
				<input type="text" name="harga_obat" class="form_login" value="<?php echo $data['harga_obat'] ?>" required>

				<label>Keterangan Obat</label>
				<input type="text" name="keterangan_obat" class="form_login" value="<?php echo $data['keterangan_obat'] ?>" required>   
			<?php
			}			?>
