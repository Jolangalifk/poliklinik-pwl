...
<head>
    ...
    <style>
        body { font-family: Arial, sans-serif; background: #f0f4f8; color: #000000ff; margin: 0; padding: 0; }
        ...
        .bayar-header h1 { margin: 0; font-size: 26px; letter-spacing: -0.3px; color: #000000ff; }
        .bayar-meta { display: grid; grid-template-columns: repeat(2, minmax(180px, 1fr)); gap: 14px; font-size: 14px; color: #000000ff; }
        ...
        .obat-table th { text-align: left; color: #000000ff; background: #f8fafc; font-weight: 700; }
        .obat-table td { color: #000000ff; }
        ...
        .summary-row.total-row { font-weight: 700; font-size: 17px; color: #000000ff; }
        ...
        .bayar-field label { display: block; margin-bottom: 8px; font-weight: 700; color: #000000ff; }
        .bayar-field select { width: 100%; padding: 12px 14px; border-radius: 12px; border: 1px solid #d8dee8; background: #fff; color: #000000ff; }
