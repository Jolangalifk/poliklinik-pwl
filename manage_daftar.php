...
<head>
	...
	<link rel="stylesheet" href="style_katalog_kanan.css">
...
<body>
    ...
    <div style="margin-top:100px;margin-left:250px">
		...
		<?php 
			include "koneksi.php";
            $query = mysqli_query($connect ,"SELECT dokter.foto_dokter, dokter.nama_dokter, poli.nama_poli, dokter.id_dokter FROM dokter, poli WHERE dokter.id_poli=poli.id_poli AND dokter.keterangan_dokter='Ada'");
					...
					<div class="card">
						...
						<div class="info">
							...
							<?php
							echo "
							<a href='proses_daftar.php?id_dokter=".$data['id_dokter']."'
							class='btn' onclick='return confirm('Daftar pemeriksaan')'>
							Daftar Periksa
							</a>
							";
							?>
