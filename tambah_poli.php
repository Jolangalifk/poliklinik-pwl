...
<body>
	...
	<div class="kotak_login" style="width: 600px; position: absolute; left: 35%; top: 130px; margin: 0; margin-top: 0;">
		<p class="tulisan_login" style="margin-bottom: 25px; font-size: 22px;">Tambah Poli</p>

		<form action="save_poli.php" method="post">

			<label for="nama_poli" style="font-size: 14px; color: #1E3A8A; font-weight: 600;">Nama Poli</label>
			<input type="text" name="nama_poli" class="form_login" placeholder="Masukkan Nama Poli" required>
