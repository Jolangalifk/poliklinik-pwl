...
<head>
	...
	<link rel="stylesheet" href="style_daftar_periksa.css">
    ...
    <div class="top-right">
      ...
      <p> 
        ...
        <ul>
			...
			<li><a href="manage_daftar.php">Periksa</a></li>
		...
		<div class="container">
			...
			<table>
				...
				<tr>
					...
					<td>
						<a href="form_pemeriksaan_dokter.php?id_daftar=<?php echo $data['id_daftar']; ?>" class="btn">Periksa</a>
					</td>
					</tr>
					<?php
						}
